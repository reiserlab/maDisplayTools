...
% Set default paths relative to maDisplayTools installation
maDisplayTools_root = fileparts(fileparts(mfilename('fullpath')));
handles.arena_folder = fullfile(maDisplayTools_root, 'configs', 'arenas');
handles.scripts_folder = fullfile(maDisplayTools_root, 'scripts');
handles.arena_file = 'arena_parameters.mat';
set(handles.text26, 'String', maDisplayTools_root);
...
%generate pattern
[handles.Pats, handles.param.true_step_size, handles.param.rot180] = Pattern_Generator(handles);
...
% save_pattern handles checkerboard via param.checker_layout internally
save_pattern(handles.Pats, handles.param, handles.save_dir, ...
