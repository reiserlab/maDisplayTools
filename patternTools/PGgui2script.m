...
if exist([script_dir 'temp_pattern_script.m'],'file')
    recycle('on');
    delete([script_dir 'temp_pattern_script.m']);
    recycle('off');
end
FID = fopen(fullfile(script_dir, 'temp_pattern_script.m'),'a');
...
fclose(FID);
edit(fullfile(script_dir, 'temp_pattern_script.m'));
