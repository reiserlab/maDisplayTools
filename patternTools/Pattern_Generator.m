function [Pats, true_step_size, rot180] = Pattern_Generator(handles)
    % FUNCTION [Pats, arena_phi, arena_theta, true_step_size, rot180] = Pattern_Generator(param)
    %
    % inputs:
    % see Pattern_Generator_script for list of inputs needed
    %
    % outputs:
